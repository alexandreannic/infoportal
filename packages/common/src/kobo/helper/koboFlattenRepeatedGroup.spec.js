...
var koboFlattenRepeatedGroup_1 = require("./koboFlattenRepeatedGroup");
describe('koboFlattenRepeatedGroup', function () {
    it('should flatten the nested objects', function () {
        expect(koboFlattenRepeatedGroup_1.KoboFlattenRepeatedGroup.run({ data: getData(), path: ['children', 'grandchildren'], replicateParentData: false })).toEqual([
            {
