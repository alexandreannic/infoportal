          ...
          return {
            ...
            label: (
              <>
                {map(_.nta, answer =>
                  <>
                    <TableIconBtn tooltip={m.view} children="visibility" onClick={() => ctxAnswers.open({answer, formId: KoboIndex.byName('shelter_nta').id})}/>
      ...
      },
      {
        ...
        render: _ => {
          return {
            ...
            label: map(_.ta, form =>
              <>
                <TableIconBtn tooltip={m.view} children="visibility" onClick={() => ctxAnswers.open({formId: KoboIndex.byName('shelter_ta').id, answer: form})}/>
