  ...
  export interface T {
      ...
      hh_char_hh_det:
        | {
            ...
            hh_char_hh_det_disability:
              | undefined
              | Option<'do_you_have_a_household_member_that_has_a_lot_of_difficulty_001'>[]
              | undefined
    ...
    group_registration_documentation: {
      ...
      are_you_and_your_hh_members_registered_as_idps:
        | undefined
        | Option<'are_you_and_your_hh_members_registered_as_idps'>
      hh_char_hh_doc:
        | {
    ...
    group_violence_coercion_n_deprivation: {
      ...
      group_violence_adult_male: {
        ...
        has_any_adult_male_member_experienced_violence:
          | undefined
          | Option<'has_any_adult_male_member_experienced_violence'>
    ...
    group_coping_strategies: {
      ...
      what_is_the_average_month_income_per_household:
        | undefined
        | Option<'what_is_the_average_month_income_per_household'>
