export namespace Partner_lampa {
export type Option<T extends keyof typeof options> = keyof (typeof options)[T]
	// Form id: axkkzwvccFtUkkL3BzSSnW
	export interface T {
	    'start': string,
	    'end': string,
	  // date [date] Дата
  ...
  'ben_det_hromada': undefined | Option<'ben_det_hromada'>,
	  // ben_det/ben_det_settlement [select_one_from_file] 2.5.4 Виберіть Населений пункт, де відбувається реєстрація
  'ben_det_settlement': string,
	  // ben_det/A5 [text] 2.5.5 Адреса проживання
  'A5': string | undefined,
	  // ben_det/ben_det_res_stat [select_one] 2.5.5 Виберіть статус проживання
  'ben_det_res_stat': undefined | Option<'ben_det_res_stat'>,
	  // ben_det/ben_det_income [integer] 2.6 Якою була загальна вартість у гривнях усіх ресурсів, отриманих Вашим домогосподарством за останній один місяць крім офіційного доходу?
  ...
  'hh_char_civ_stat': undefined | Option<'hh_char_civ_stat'>,
	  // hh_char/hh_char_pensioner [select_one] 3.1.1 Чи є в домогосподарстві хто-небудь, хто отримує пенсію?
  ...
  'hh_char_chh': string,
	  ...
	  // casf_utilities_fuel/current_gov_assist_cff [select_one] Чи отримуєте ви зараз або очікуєте отримати фінансову допомогу для покриття ваших потреб в оплаті твердого палива?
  ...
  'utilities_fuel': undefined | Option<'utilities_fuel'>,
	  // casf_utilities_fuel/functioning_fuel_delivery [select_one] Чи є у вашому регіоні функціонуюча доставка/постачальник твердого палива?
  ...
  'ass_inc_cfu_not_vul': string,
	  // pay_det/pay_consent [select_one] 7.0 Дякуємо за відповіді на вищезазначені питання, чи готові ви надати свої платіжні реквізити?
...
ben_det_res_stat: {
	...
	'long_res': `Місцевий мешканець`,
	'ret': `Особа, яка повернулася`,
	'ref_asy': `Особа, що потребує прихистку`
},
