...
export const SelectMultiple = forwardRef(SelectMultipleInner) as <T extends string | number = string>(
  props: IpSelectMultipleProps<T> & {ref?: React.Ref<HTMLInputElement>},
